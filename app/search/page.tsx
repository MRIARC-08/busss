...
import { Loader2, ArrowRight, Bus, MapPin, Clock } from "lucide-react";
        ...
        <div className="flex justify-between items-start">
           <div className="flex items-center gap-3">
              ...
              <div>
                 ...
                 <p className="text-sm text-gray-500 font-medium mt-0.5">Vehicle {bus.id}</p>
              </div>
           </div>
    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm mb-8 flex justify-between items-center">
         <div>
            ...
            <p className="text-gray-500 font-medium mt-1">Found {data.upcoming.length + data.departed.length} buses operating on this trajectory</p>
         </div>
      </div>
