...
export function PWAInstallPrompt() {
  ...
  return (
    <div className="fixed bottom-6 left-4 right-4 z-[9999] sm:left-auto sm:right-6 sm:bottom-6 sm:max-w-sm sm:w-full">
      <div className="bg-white rounded-2xl shadow-2xl border border-brand-100 p-4 flex items-center gap-3 animate-in slide-in-from-bottom-5 fade-in duration-500">
