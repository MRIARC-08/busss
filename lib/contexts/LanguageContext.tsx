...
const translations: Translations = {
  en: {
    ...
    "search.loading": "Scanning live regional GTFS network and stop topologies...",
    "search.route": "Route",
  ...
  hi: {
    ...
    "search.loading": "लाइव क्षेत्रीय GTFS नेटवर्क और स्टॉप टोपोलॉजी को स्कैन किया जा रहा है...",
    "search.route": "रूट",
    "search.vehicle": "वाहन",
